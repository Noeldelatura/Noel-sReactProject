...
const Register = () => {
    ...
    return (
        <div>
            <div className="main-container-reg shadow-md mb-5 ">
                <div>
                    <h2 className="mt-8 text-center text-2xl  leading-9 tracking-tight text-pink-800 dark:text-black ">
                        Register
                    </h2>
                    ...
                    <form noValidate onSubmit={handleSubmit(onRegister)} className=" flex  flex-col justify-end items-center  px-6 py-12 lg:px-8 gap-4 ">
                        ...
                        />
                        {errors.name?.first && (
                            <p className="text-pink-800">{errors.name.first.message}</p>
                        )}
                        <input
                            className="custom-input-reg"
                        ...
                        />
                        {errors.name?.middle && (
                            <p className="text-pink-800">{errors.name.middle.message}</p>
                        )}
                        ...
                        />
                        {errors.name?.last && (
                            <p className="text-pink-800">{errors.name.last.message as string}</p>
                        )}
                        ...
                        />
                        {errors.phone && (
                            <p className="text-pink-800">{errors.phone?.message as string}</p>
                        )}
                        ...
                        />
                        {errors.email && (
                            <p className="text-pink-800">{errors.email?.message as string}</p>
                        )}
                        ...
                        />
                        {errors.image?.url && (
                            <p className="text-pink-800">{errors.image?.url?.message}</p>
                        )}
                        ...
                        />
                        {errors.image?.alt && (
                            <p className="text-pink-800">{errors.image?.alt?.message}</p>
                        )}
                        ...
                        {errors.address?.state && (
                            <p className="text-pink-800">{errors.address?.state?.message}</p>
                        )}
                        ...
                        {errors.address?.country && (
                            <p className="text-pink-800">{errors.address?.country?.message}</p>
                        )}
                        ...
                        />
                        {errors.address?.city && (
                            <p className="text-pink-800">{errors.address?.city?.message}</p>
                        )}
                        ...
                        {errors.address?.street && (
                            <p className="text-pink-800">{errors.address?.street?.message}</p>
                        )}
                        ...
                        <section className="checkbox-container flex flex-row-reverse gap-2 dark:text-white">
                            ...
                            {errors.isBusiness && (
                                <p className="text-pink-800">{errors.isBusiness?.message}</p>
                            )}
