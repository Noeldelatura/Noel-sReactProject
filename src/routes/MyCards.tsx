        ...
        <div className="flex flex-col">
            ...
            <div className="flex flex-wrap justify-center items-center gap-5 mt-2 dark:text-black">
                {cards.map((card: CardType, index: number) => (
                    <div className="flex flex-col justify-center items-center p-5 rounded-md text-center bg-pink-200 m-2 dark:bg-pink-800 relative drop-shadow-md favorite-cards-style mt-1" key={index}>
                        <Link to={`/cards/${card._id}`} className="flex flex-col items-center ">
                            ...
                            <div className=" bg-pink-200 m-2 dark:bg-pink-800 p-5 rounded-md drop-shadow-md  dark:text-white w-80 text-left">
