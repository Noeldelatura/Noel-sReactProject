...
const Profile = () => {
    ...
    return (
        <div className="flex flex-col justify-center items-center gap-5 mt-2 ">
            ...
            {user && (
                <div className="flex flex-col justify-center items-center p-5 rounded-md text-center bg-pink-200 m-2  dark:bg-pink-800 dark:text-white drop-shadow-md card-style">
                    <img
            ...
            {user && user.address && (
                <div className=" bg-pink-200 m-2 dark:bg-pink-800 p-5 rounded-md drop-shadow-md  dark:text-black w-80 ">
                    <h3 style={{ color: "pink" }} className="text-l  py-0.5 font-bold">Address :</h3>
