...
const Card = () => {
    ...
    return (
        <div className="flex flex-col justify-center items-center gap-5 mt-2 ">
            {card && (
                <div className="flex flex-col justify-center items-center p-5 rounded-md text-center bg-pink-200 m-2  dark:bg-pink-100 dark:text-black drop-shadow-md card-style">
                    <img
            ...
            <div className=" flex flex-wrap justify-center ">
                ...
                {card && card.address && (
                    ...
                    <div className=" bg-pink-100 m-2 dark:bg-pink-200 p-5 rounded-md drop-shadow-md  dark:text-black w-80 ">
                        <h3 style={{ color: "rgb(201, 84, 104)" }} className="text-l  py-0.5 font-bold">Address :</h3>
                ...
                <div className="text-sm text-center w-80 bg-pink-100 m-2 dark:bg-pink-200 p-5 rounded-md drop-shadow-md  dark:text-black "><h3 style={{ color: "rgb(201, 84, 104)" }} className="text-l px-1 py-0.5 font-bold">Description : </h3> {card?.description}</div>
            </div>
        </div>
    );
};
