    ...
    return (
        <div className="flex flex-col">
            ...
            <div className="flex flex-wrap justify-center items-center gap-5 mt-2 dark:text-black">
                {favoriteCards.map((c) => (
                    <div key={c._id} className="flex flex-col justify-center items-center p-5 rounded-md text-center bg-pink-100 m-2 dark:bg-pink-200 relative drop-shadow-md favorite-cards-style">
                        <Link to={`/cards/${c._id}`} className="flex flex-col items-center ">
                            ...
                            />
                            <div className="mt-1">
                                <h2 style={{color: "rgb(201, 84, 104)" }} className="text-l px-1 py-0.5 font-bold">{c.title}</h2>

                                <div className=" bg-pink-300 m-2 dark:bg-pink-400 p-5 rounded-md drop-shadow-md  dark:text-white w-80 text-left">
