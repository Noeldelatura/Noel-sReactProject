...
const NavBar = () => {
    ...
    return (
        <nav className="site-navbar text-xl  leading-6 tracking-tight text-pink-900  dark:text-pink-100 mx-6">
            ...
            <div className="nav-right">
                <div className="hidden md:flex md:flex-row gap-4">
                    ...
                    {isLoggedIn && <NavLink to="/favoritecards" className="nav-link">❤️</NavLink>}
                ...
                <div className="md:hidden">
                    <button onClick={toggleMenu} className="text-white focus:outline-none focus:text-pink-300">
            ...
            {
                isMenuOpen && (
                    <div className="space-y-4 px-4 pt-3 pb-5 mx-2 rounded-md drop-shadow-md bg-pink-200 dark:bg-pink-500 fixed top-16 right-0 left-0 flex flex-col z-50 favorite-cards-style">
                        {isLoggedIn && <NavLink to="/cards" className="nav-link">Cards</NavLink>}
                        {isLoggedIn && <NavLink to="/favoritecards" className="nav-link">❤️</NavLink>}
